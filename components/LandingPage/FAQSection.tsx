...
const faqData = [
    {
        ...
        answer: 'Bidalyze es una plataforma que ofrece estadísticas y análisis para que las empresas puedan tomar mejores decisiones en sus ofertas y licitaciones.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Bidalyze ofrece un plan gratuito con funcionalidades limitadas y planes premium para características avanzadas.'
    },
    {
    ...
    return (
        <div style={{ padding: '40px 0' }}>
            ...
            <Space direction="vertical" style={{ width: "100%" }}>
                {faqData.map((faq, index) => (<Collapse
                    key={`collapse-${index}`}
                    accordion
                    bordered={false}
                ...
                >
                    <Panel
                        key={`panel-${index}`}
                        header={<Title level={5} style={{ margin: 0 }}>{faq.question}</Title>}
                        style={panelStyle}
                    >

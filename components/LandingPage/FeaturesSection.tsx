  ...
  return (
    <Row gutter={[32, 32]} justify="center" style={{ marginTop: '50px' }}>
      ...
      <Col xs={24} md={12} lg={10}>
        ...
        <Space direction="vertical" size="large" style={{ display: 'flex' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Image src={theme === 'dark' ? '/assets/custom-predictive-icon-dark.png' : '/assets/custom-predictive-icon.png'} alt="Análisis Predictivo" width={32} height={32} />
            <div>
              <Text strong style={{ fontSize: '16px' }}>Análisis Predictivo</Text>
              <Text style={{ display: 'block' }}>Visualiza cuándo una empresa necesita reabastecer.</Text>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Image src={theme === 'dark' ? '/assets/custom-reports-icon-dark.png' : '/assets/custom-reports-icon.png'} alt="Reportes Detallados" width={32} height={32} />
            <div>
              <Text strong style={{ fontSize: '16px' }}>Reportes Detallados</Text>
              <Text style={{ display: 'block' }}>Ejemplos interactivos para mejor comprensión.</Text>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Image src={theme === 'dark' ? '/assets/custom-alerts-icon-dark.png' : '/assets/custom-alerts-icon.png'} alt="Alertas de Oportunidad" width={32} height={32} />
            <div>
              <Text strong style={{ fontSize: '16px' }}>Alertas de Oportunidad</Text>

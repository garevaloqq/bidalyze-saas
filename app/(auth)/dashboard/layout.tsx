  ...
  children: [
    {
      ...
      label: <Search placeholder="Buscar..." style={{ padding: "0 10px", margin: "4px 0" }} />,
      key: "search-input",
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <Space size="large">
          ...
          <Image
            src="https://pstatic.cryptoquant.com/logo/cryptoquant_logo_dark.svg"
            width={163}
            height={21}
            alt="cryptoquant-logo"
          />
        </Space>
      ...
      <Layout>
        ...
        <Sider collapsible collapsed={collapsed} onCollapse={setCollapsed} width={"25%"} trigger={null}>
          ...
          <Button
            ...
            style={{ fontSize: 18 }}
          />
          <Menu mode="inline" items={menuItems.map(({ key, label }) => ({ key, label }))} />
        </Sider>

        {/* Contenido principal */}
        <Content style={{ margin: "24px", padding: 24 }}>{children}</Content>
      </Layout>
